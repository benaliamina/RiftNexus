 ...
 * This file demonstrates how to integrate Riftnexus with a web frontend
 */

// For React/Vue/Angular applications
export class RiftnexusClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RiftnexusClient(provider, contractAddress);
